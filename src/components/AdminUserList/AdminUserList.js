...
const AdminUserList = () => {
    ...
    const handleUpdate = () => {
        ...
        const { id, username, email, first_name, last_name, is_verified, is_staff, is_active, date_joined, role } = updatedUserData;
        ...
        axios.patch(`${API_URL}/users/users/${id}/`, { username, email, first_name, last_name, is_verified, is_staff, is_active, date_joined, role: roleAsString }, {
            headers: {
                Authorization: `Bearer ${accessToken}`
            }
        })
    ...
    return (
        <React.Fragment>
            <div className='admin_toggle_container'>
                ...
                <button className='table_control_button' onClick={() => setShowCreateModal(true)}>Create User</button>
                    ...
                    <div class="filter-container">
                        ...
                        <div class="filter-item">
                            ...
                            <select id="role" value={roleFilter} onChange={(e) => setRoleFilter(e.target.value)} className="role-filter">
                                ...
                                <option value="Operationteam">Operationteam</option>
